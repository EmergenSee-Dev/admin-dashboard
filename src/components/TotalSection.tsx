  ...
  return (
    <section className='grid lg:grid-cols-3 gap-6'>
      <div className='bg-white flex justify-between rounded-xl p-6'>
        ...
        <div className='bg-[#66B5FF33] p-4 rounded-md text-[#3688FF]'>
      ...
      <div className='bg-white flex justify-between rounded-xl p-6'>
        ...
        <div className='bg-[#671C7333] p-4 rounded-md text-[#671C73]'>
      ...
      <div className='bg-white flex justify-between rounded-xl p-6'>
        ...
        <div className='bg-[#FFA31A33] p-4 rounded-md text-[#FFA31A]'>
